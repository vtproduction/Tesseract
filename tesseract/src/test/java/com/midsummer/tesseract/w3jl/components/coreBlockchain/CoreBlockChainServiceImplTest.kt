...
class CoreBlockChainServiceImplTest {
    ...
    fun setUp() {
        ...
        coreBlockChainServiceImpl = CoreBlockChainServiceImpl(web3j)
    }
    ...
    fun getAccountBalance() {
        ...
        assertEquals("get Account balance",BigInteger("9059497695991194751"), coreBlockChainServiceImpl?.getAccountBalance(wallet)?.blockingGet())
    }
    ...
    fun getTransactionCount() {
        val wallet = EntityWallet()
        wallet.address = "0x6e7312d1028b70771bb9cdd9837442230a9349ca"
        assertEquals("get Account Transaction count",BigInteger("1284"), coreBlockChainServiceImpl?.getTransactionCount(wallet)?.blockingGet())
    }
